...
def train():
    ...
    for fold in range(kfold):
        ...
        for i in range(len(allfile)):
            ...
            lon_diff = data_df['lon_diff'].tolist()
            data_loc.append(lon_diff)
            lat_diff = data_df['lat_diff'].tolist()
            data_loc.append(lat_diff)
            dir_diff = data_df['dir_diff'].tolist()
            data_loc.append(dir_diff)
        ...
        # print(np.array(trainfeature).shape)
        # print(np.array(train_tag).shape)
        # print(trainfeature)
        trainacc = -1
        validacc = -1
        testacc = -1
